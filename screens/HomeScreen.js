  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: C.white }}>
      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
        ...
        {/* Search */}
        <View style={[s.searchBox, { backgroundColor: C.background }]}>
...
const s = StyleSheet.create({
  ...
  searchBox:     { flexDirection: 'row', alignItems: 'center', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, marginBottom: 20 },
